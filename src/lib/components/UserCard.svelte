        ...
        <div class="flex gap-1 items-center flex-col md:flex-row md:items-start md:gap-5">
            ...
            <div class="flex gap-2 items-center flex-col mt-1 md:block md:mt-10">
                ...
                <ul class="flex flex-wrap gap-2 justify-center mt-6 text-sm text-secondary-200 md:justify-start">
                    <li><a target="_blank" href="/" class="inline-block px-3 py-1 rounded-full bg-primary-200 hover:text-white">Bluesky</a></li>
                    <li><a target="_blank" href="/" class="inline-block px-3 py-1 rounded-full bg-primary-200 hover:text-white">Behance</a></li>
                    <li><a target="_blank" href="/" class="inline-block px-3 py-1 rounded-full bg-primary-200 hover:text-white">GitHub</a></li>
                    <li><a href="mailto:fake.email@fake.email" class="inline-block px-3 py-1 rounded-full bg-primary-200 hover:text-white">Email</a></li>
                </ul>
            </div>
        </div>
    </div>
